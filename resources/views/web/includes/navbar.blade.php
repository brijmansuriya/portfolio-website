                            ...
                            <div class="header-nav-main header-nav-main-square header-nav-main-effect-2 header-nav-main-sub-effect-1">
                                <nav class="collapse">
                                    <ul class="nav nav-pills" id="mainNav">
                                        <li class="dropdown"> 
                                            <a class="dropdown-item dropdown-toggle" href="{{route('home')}}"> Home</a>
                                        </li>
                                        <li class="dropdown"> 
                                        ...
                                        <li class="dropdown">
                                            <a class="dropdown-item dropdown-toggle" href="{{route('projects')}}"> projects</a>
                                        </li>
                                        <li class="dropdown">
                                            <a class="dropdown-item dropdown-toggle" href="{{route('contactus')}}"> contact us</a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
